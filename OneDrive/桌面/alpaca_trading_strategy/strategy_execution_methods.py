#!/usr/bin/env python3
"""
Strategy Execution Methods - Complete Implementation
==================================================
All strategy execution and helper methods
"""

# Continue adding these methods to AlpacaCompleteStrategy class:
...
def save_data(self):
    ...
    try:
        ...
        weights_data = {
            ...
            'ic_history': {k: list(v) for k, v in self.factor_ic_calculator.ic_history.items()} if hasattr(self, 'factor_ic_calculator') else {}
        }
